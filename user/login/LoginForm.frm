...
Begin Form
    ...
    End
    PrtDevMode = Begin
        0x00000000ba28d22f0400000001000000a05b3f0018000000145e3f00c85b3f00 ,
        0x010400069c00440353ef8001010009009a0b3408640001000f00580202000100 ,
        0x580203000100413400000000c81ce804005e3f00c41ce804f85b3f00e993d42f ,
        0xe01ce804f0930000000000000000000000000000010000000000000001000000 ,
...
'---------------------------------------------------------------------------------------
'/**
' @brief Formular für Benutzeranmeldung
'**/
'---------------------------------------------------------------------------------------
'<codelib>
'  <file>user/login/LoginForm.frm</file>
...
Private Sub Form_Load()
   ...
   Dim Args() As String
   Dim LoginFormBridgePtr As Long

   If Len(Me.OpenArgs) > 0 Then 'OpenArgs= "ObjPtr@Caption@StandardUser"
      Args = Split(Me.OpenArgs, "@")
      
      LoginFormBridgePtr = Val(Args(0))

      Me.Caption = Args(1)
      If UBound(Args) > 1 Then
         Me.txtUID.Value = Args(2)
      Else
         Me.txtUID.Value = vbNullString
      End If
   ...
   Set tempObj = GetObjectFromObjPtr(LoginFormBridgePtr)
...
Private Function GetObjectFromObjPtr(lPtr As Long) As Object

   Dim obj As Object
   CopyMemory obj, lPtr, 4
   Set GetObjectFromObjPtr = obj
   CopyMemory obj, 0&, 4
