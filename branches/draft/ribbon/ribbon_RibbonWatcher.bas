...
Public Sub RibbonWatcherCallBack_OnLoad(ribbon As IRibbonUI)
...
Public Sub RibbonWatcherCallBack_GetLabel(rc As IRibbonControl, _
...
Public Sub RibbonWatcherCallBack_GetImages(rc As IRibbonControl, _
...
Public Sub RibbonWatcherCallBack_GetVisible(ByRef rc As IRibbonControl, ByRef visible As Variant)
...
Sub RibbonWatcherCallBack_EditBox_onChange(rc As IRibbonControl, _
                                    strText As String)
