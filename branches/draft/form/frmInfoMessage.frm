...
Begin Form
    ...
    End
    GUID = Begin
        0xaa920908ae86eb47b7a4015ab7efe336
    End
    Caption ="Information"
    ...
    Begin
        ...
        Begin Section
            ...
            OnClick ="[Event Procedure]"
            GUID = Begin
                0x6b094cebd8c1c248b973669b53073d4c
            End
            Begin
                Begin TextBox
                    Enabled = NotDefault
                    ...
                    OnClick ="[Event Procedure]"
                    GUID = Begin
                        0x4c93ebd4ccce9943a7a39285f54273ae
                    End
                    TextFormat =1
                    HorizontalAnchor =2
                    VerticalAnchor =2
...
'*********************************************************
   ...
   With sRect
      ...
      lngRet = apiDrawText(hDC, strText, -1, sRect, DT_CALCRECT Or DT_TOP Or DT_LEFT Or DT_WORDBREAK Or DT_NOCLIP)  ' not for this version!
